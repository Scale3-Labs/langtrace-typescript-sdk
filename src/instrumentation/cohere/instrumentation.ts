...
import { ChatFn, ChatStreamFn, EmbedFn } from '@langtrace-instrumentation/cohere/types'
import { chatPatch, chatStreamPatch, embedPatch } from '@langtrace-instrumentation/cohere/patch'
